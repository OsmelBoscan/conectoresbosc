    ...
    <ul class="space-y-4" id="covers">
        @foreach($covers as $cover)
            ...
            data-id="{{ $cover->id }}">
                ...
                <img src="{{ $cover->image }}" alt="" class="w-full lg:w-64 aspect-[3/1] object-center">
                ...
                <div class="p-4 lg:flex-1 lg:flex lg:justify-between lg:items-center space-y-3 lg:space-y-0">
                    ...
                    <div>
                        ...
                        <p>
                            @if ($cover->is_active)
                               <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-green-900 dark:text-green-300">Activo
                               </span>
                            @else
                                <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300">Inactivo
                                </span>
                            @endif
                        </p>
                    </div>
