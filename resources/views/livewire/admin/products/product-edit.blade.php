<div>
    ...
    <form wire:submit="store">
        ...
        <figure class="mb-4 relative">
            ...
            <label class="flex items-center px-4 py-2 rounded-lg bg-white cursor-pointer text-gray-700 shadow-sm"> 
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="productEdit.sku" class="w-full" placeholder="Por favor ingrese el Codigo del producto"/>
            </div>
            ...
            <div class="mb-4">
                ...
                <x-textarea wire:model="productEdit.description" class="w-full" placeholder="Por favor ingrese la Descripcion del producto"/>
            </div>
     ...
     <div class="flex justify-end mt-4">
      ...
      <form action="{{ route('admin.products.destroy', $product) }}" method="POST" class="mt-4" id="delete-form">
      ...
      @push('js')
        <script>
            ...
            Swal.fire({
            title: "Estas Seguro?",
            text: "No podras de revertir esto!",
            icon: "warning",
