        ...
        <div class="p-4">
            ...
            <div class="grid grid-cols-4 gap-4">
                ...
                <div class="col-span-2">
                    <x-input wire:model="createAddress.district"
                    class="w-full" 
                    type="text" 
                    placeholder="Estado"
                    />
            ...
            <div x-data="{
                ...
                <p class="font-semibold mb-2">
                    ...
                    <label class="flex items-center">
                        <input x-model="receiver" type="radio" wire:model="createAddress.receiver" value="1" class="mr-1">
                        Seré yo
                    </label>
                    <label class="flex items-center">
                        <input x-model="receiver" type="radio" wire:model="createAddress.receiver" value="2" class="mr-1">
                        Otra Persona
                    </label>
                </div>
            ...
            <div class="grid grid-cols-4 gap-4">
                ...
                <div class="col-span-2">
                    <x-input wire:model="editAddress.district"
                    class="w-full" 
                    type="text" 
                    placeholder="Estado"
                    />
